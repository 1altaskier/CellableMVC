    ...
    public class USPSManager
    {
        ...
        public Address GetZipcode(Address address)
        {
            try
            {
                ...
                string zipcodeurl = "?API=ZipCodeLookup&XML=<ZipCodeLookupRequest USERID='" + USPSAPIUserName + "' PASSWORD='" + USPSAPIPassword + "'><Address ID=\"{1}\"><Address1>{2}</Address1><Address2>{3}</Address2><City>{4}</City><State>{5}</State></Address></ZipCodeLookupRequest>";
